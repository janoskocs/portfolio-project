...
function datePickPage() {
    ...
    datePickPageHTML += "<option value=\"2020\">2020</option>";
    datePickPageHTML += "<option value=\"2021\">2021</option>";
    datePickPageHTML += "</select>";
    //YEARS
...
function confirmationPage() {
    ...
    confirmationHTML += "<a href=\"https://janoskocs.com\">janoskocs.com</a>";
    confirmationHTML += "</div>";
